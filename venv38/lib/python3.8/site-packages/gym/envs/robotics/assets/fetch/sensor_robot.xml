<mujoco>
    ...
    <body childclass="robot0:fetch" name="robot0:base_link" pos="0.2869 0.2641 0">
                    ...
                    <body name="robot0:head_camera_link" pos="0.055 0 0.0225">
                        ...
                        <body name="robot0:head_camera_rgb_frame" pos="0 0.02 0">
                            ...
                            <body name="robot0:head_camera_rgb_optical_frame" pos="0 0 0" quat="0.5 -0.5 0.5 -0.5">
                                ...
                                <camera euler="3.1415 0 0" fovy="50" name="robot0:head_camera_rgb" pos="0 0 0"></camera>
                            </body>
                        </body>
                                ...
                                <body name="robot0:wrist_flex_link" pos="0.1245 0 0">
                                    ...
                                    <body name="robot0:wrist_roll_link" pos="0.1385 0 0">
                                        ...
                                        <body euler="0 0 0" name="robot0:gripper_link" pos="0.1664 0 0">
                                            <!-- Rangefinder site -->
                                            <site name="sensor_forward_site" pos="0 0 0.1" size="0.01" rgba="1 0 0 1" type="sphere" quat="0 0 0 1"></site>
                                            <site name="sensor_right_site" pos="0 0.1 0" size="0.01" rgba="0 1 0 1" type="sphere" quat="0.707 -0.707 0 0"></site>
                                            <site name="sensor_left_site" pos="0 -0.1 0" size="0.01" rgba="1 1 0 1" type="sphere" quat="0.707 0.707 0 0"></site>
                                            <site name="sensor_backward_site" pos="0 0 -0.1" size="0.01" rgba="0 0 1 1" type="sphere" quat="0 0 1 0"></site>
                                            ...
                                            <body name="robot0:gipper_camera_link" pos="0.055 0 0.0225">
                                                <body name="robot0:gripper_camera_rgb_frame" pos="0 0.02 0">
                                                    <body name="robot0:gripper_camera_rgb_optical_frame" pos="0 0 0" quat="0.5 -0.5 0.5 -0.5">
                                                        <camera euler="3.1415 0 0" fovy="50" name="robot0:gripper_camera_rgb" pos="0 0 0"></camera>
                                                    </body>
                                                </body>
                                            ...
                                            <site name="robot0:grip" pos="-0.28 0.28 -.065" rgba="0 0 0 0" size="0.02 0.02 0.02"></site>
                                        </body>
                                    </body>
                                </body>
                            </body>
        ...
        <body name="robot0:laser_link" pos="0.235 0 0.2878" quat="0 1 0 0">
            ...
            <camera euler="1.55 -1.55 3.14" fovy="25" name="robot0:lidar" pos="0 0 0.02"></camera>
        </body>
        ...
        <body name="robot0:external_camera_body_0" pos="0 0 0">
            <camera euler="0 0.75 1.57" fovy="43.3" name="robot0:external_camera_0" pos="1.3 0 1.2"></camera>
        </body>
    </body>
</mujoco>